    ...
    <div className="rounded-xl shadow p-2 bg-white h-[450px] flex flex-col w-full">
      <div className="relative h-full">
        <img
          src={imageUrl}
          alt={productName}
          className="rounded-lg w-full h-full object-cover aspect-[4/3]" // consistent aspect ratio
        />
      ...
      <button className="w-full mt-3 bg-green-200 text-green-800 py-1.5 rounded-full flex justify-center items-center gap-2">
        <CartIcon />
        Add to cart
      </button>
    </div>
